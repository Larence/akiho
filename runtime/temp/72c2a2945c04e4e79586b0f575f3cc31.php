<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\xampp\htdocs\lang\public/../application/member\view\message\board.html";i:1556603432;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    layui.use(['table','form'],function(){
        ...
        form.on('switch(is_contact)', function(obj){
            ...
            $.ajax({
                ...
                type:'post',
                dataType:'json',
                data:{id:id,is_contact:is_contact,type:'board'},//表格数据序列化
